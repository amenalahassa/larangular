                    ...
                    @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" name="tel" class="form-control" id="inputTel" placeholder="+229 66666666" required>
                                @error('tel')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="file"  style="display: none"  accept="image/*" required  name="photo" id="file-2" class="inputfile inputfile-2" data-multiple-caption="{count} files selected" required />
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" name="ref" class="form-control" pattern="[A-Za-z]{3}" id="inputRef" maxlength="3" minlength="3"  size="3" required>
                            </div>
                            @error('ref')
                            <span style="display: block; margin: 10px 10px;" class="alert alert-warning" role="alert">
                                        <strong>{{ $message }}</strong>
